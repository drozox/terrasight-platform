...
// =============================================================================
// MonitoreoMapClient — shell del mapa del módulo de monitoreo (HU-MO-01).
//
// ESTE ARCHIVO SE CARGA SOLO EN EL CLIENTE (via dynamic import con
// ssr: false desde `./monitoreo-map.tsx`). NUNCA importes leaflet en un
// archivo que se incluya en el bundle del server — el entry point de
// Leaflet hace `window.L = ...` y rompe con `ReferenceError: window is
// not defined` durante el SSR.
//
...
// Componente público
// -----------------------------------------------------------------------------
export function MonitoreoMapClient({ puntos }: { puntos: MonitoreoPunto[] }) {
