...
export function MapCompass() {
  return (
    <div className="absolute bottom-6 right-4 top-auto z-[600] flex h-12 w-12 items-center justify-center rounded-full border border-outline-variant/40 bg-surface-container-lowest/95 shadow-md backdrop-blur">
