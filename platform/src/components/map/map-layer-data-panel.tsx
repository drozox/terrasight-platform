...
export const LAYER_DATA_META: Record<string, LayerMeta> = {
  ...
  quebradas:   { url: "/api/geo?layer=drenajes",    title: "Quebradas / Drenajes", cols: [{ key: "nombre", label: "Nombre" }, { key: "estado", label: "Estado" }] },
  rios:        { url: "/api/geo?layer=drenajes",    title: "Ríos / Drenajes",      cols: [{ key: "nombre", label: "Nombre" }, { key: "estado", label: "Estado" }] },
