...
// -----------------------------------------------------------------------------
// (Los tipos MetaResumen / MetasGlobal / MunicipioIntervenido se eliminaron en
// Sprint 23: el endpoint /api/metas que los usaba se removió y la fuente única
// de metas ahora es src/lib/repos/metas-convenio.ts)
// -----------------------------------------------------------------------------
